                            ...
                            {photoPreview ? (
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-xs text-base-content/40">{photoFile ? (photoFile.size / 1024).toFixed(1) + " KB" : ""}</p>
                                        <button type="button" className="btn btn-ghost btn-xs text-error w-fit" onClick={removePhoto}>
                                            Hapus foto
                                        </button>
                                    </div>
                                </div>
